      ...
      try {
        ...
        if (valid) {
          ...
          if(properties.auth==null&&properties.authType!=null||properties.auth!=null&&properties.authType==null){
            reject({error:"If you will use authentication you need to fill auth and authType properties."});
          }
          ...
          if(properties.addData!=null){
            try{
              JSON.parse(properties.addData);
            }catch(e){
              reject({error:"For the addData propertie specify a JSON Object."+e});
            }
